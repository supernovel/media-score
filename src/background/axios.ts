import axios, { AxiosError, AxiosResponse, CustomParamsSerializer, InternalAxiosRequestConfig, ParamsSerializerOptions } from "axios";
import qs from "qs";
        ...
        promiseChain.push(
            new Promise((resolve, reject) => {
                setTimeout(() => {
                    ...
                    reject(new axios.AxiosError(message, 'ECONNABORTED', config, request));
                }, config.timeout);
            })
        );
    }
...
function buildURL(url: string, params: object, options?: ParamsSerializerOptions | CustomParamsSerializer) {
    ...
    let serializedParams = serializeFn == null ? qs.stringify(params) : serializeFn(params, options);
